package com.arise.common.ming.component;
...
public class IntensiveFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public IntensiveFragmentTabHost(Context context) {
    ...
    public IntensiveFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
